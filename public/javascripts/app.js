$(function() {
	...
	$(document).ready(function(){
		$.getJSON("http://search.twitter.com/search.json?callback=?&q=chicago%2C%20instagr.am&nots=RT&filter=links&rpp=8", function(json_results){
